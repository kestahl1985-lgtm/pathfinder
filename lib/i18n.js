...
const STRINGS = {
  en: {
    ...
    reportCaption: (name) =>
      ...
      "💌 *Want a parent or teacher to see this?* Press and hold the PDF above, tap *Forward*, then choose who to send it to.\n\n" +
  ...
  af: {
    ...
    reportCaption: (name) =>
      ...
      "💌 *Wil jy hê 'n ouer of onderwyser moet dit sien?* Druk en hou die PDF hierbo, tik *Forward*, en kies vir wie om dit te stuur.\n\n" +
