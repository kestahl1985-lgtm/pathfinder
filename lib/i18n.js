...
const STRINGS = {
  en: {
    ...
    invalidAge: "🤔 Sorry, that's not a recognised answer. Please reply with your age in years (for example, 16 or 34).",
    askAgeQuestion: "How old are you? (e.g. 16 or 34)",
    askProvince: "Thanks! 📍\n\nWhich province do you live in?",
    askProvinceRetry: "🤔 Sorry, I didn't recognise that province. Which province do you live in? 📍",
    provinceListButton: "Choose province",
    askStatus: "Thanks! �� 📝\n\nAre you currently in Grade 12, unemployed, studying, or working?",
    askStatusRetry: "���🤔 Sorry, that's not a recognised answer. Please reply with a number from the list �� 👇",
    statusListButton: "Choose status",
    askFunding: "Thanks! �� 💰\n\nHow do you plan to fund your tertiary studies or next career move?",
    askFundingRetry: "���🤔 Sorry, that's not a recognised answer. Please reply with a number from the list �� 👇",
    fundingListButton: "Choose funding",
    ...
    exploreInstruction: (n) => `\n👉 Reply with a *number (1–${n})* to explore a career — why it fits you, what you'll need to get there, and how to qualify.`,
    ...
    careerAiImpact: "🤖 *AI impact on this career:*",
    sponsoredNear: "\n\n🏫 *Sponsored option near you:*",
    sponsorInfoPrompt: "\n\n💬 Reply *INFO* for entrance requirements — no data-heavy website needed.",
    infoHeader: (college, course) => `🎓 *${course}*\nat ${college}\n\nHere's what you need to get in:`,
    infoSubjects: "📘 *Entry requirements:*",
    infoDuration: (yrs) => `⏳ *Length of study:* ${yrs} year${yrs === 1 ? "" : "s"}`,
    infoApply: "🔗 *Apply or ask them directly:*",
    infoNothingToShow: "🤔 There's no sponsor course to show details for yet. Pick a career below and I'll show you what's available 👇\n\n",
    prospectusCaption: (collegeName) => `📄 *${collegeName}'s full prospectus* — everything about this course, straight from them.`,
    ...
    reportCaption: (name) =>
      ...
      "It lays out your strengths, your matched careers, exactly what you'll need to get there and how to qualify.\n\n" +
      "💌 *Want to share this with someone?* Press and hold the PDF above, tap *Forward*, then choose who to send it to.\n\n" +
      "_Reply REPORT anytime to get it again._",
    yesnoButtons: ["No", "Maybe", "Yes"],
    consentButtons: ["I agree", "More info"],
    // ---- Study paths (3-way menu) ----
    pathChoicePrompt: (name) =>
      `✅ Thanks ${name}, your profile is set!\n\n` +
      `How would you like Vula to help you today? 👇`,
    pathButtons: ["Do the quiz"],
    studyCategoryPrompt: "Great! Which kind of work interests you most? Pick an area and I'll show you careers in it. 👇",
    studyCategoryButton: "Choose an area",
    studyCareerListHeader: (area) => `💼 *${area}* careers:\n\n`,
    studyPickInstruction: (n) => `\n👉 Reply with a *number (1–${n})* to see exactly what it takes to study it.`,
    studyNav: "\n\n_Reply *AREAS* to pick another area, or *QUIZ* to take the assessment instead._",
    studyPickInvalid: "🤔 Sorry, that's not on the list. Please reply with a number from the list 👇",
    subjectsMathsPrompt: "Let's see what your subjects open up! 📚\n\nFirst — which *Maths* do you take at school? 👇",
    mathsButtons: ["Pure Maths", "Maths Literacy", "No Maths"],
    reachableHeader: (n) => `✅ Good news — that opens up *${n}* careers you could study for:\n\n`,
    reachableNone: "With those subjects there are no direct matches in my list yet — but the 30-question quiz can still point you to careers that fit your interests. Reply *QUIZ* to try it. 💡",
    reqSubjectsHeader: "*Subjects you'll need:*",
    reqOpenEntry: "*Open entry* — no specific school subjects required to start.",
    reqMathsHeader: "*Maths:*",
    mathsPureRequired: "Pure Maths required (Maths Literacy is not accepted).",
    mathsEitherOk: "Pure Maths or Maths Literacy accepted.",
    mathsNoneNeeded: "No Maths requirement to get in.",
    reqVerifyCaveat: "⚠️ _Please confirm these exact requirements with the institution — they can differ between colleges and change year to year._",
    studyNoData: "🤔 Sorry, I don't have the study details for that one yet.",
  },
  ...
  zu: {
    ...
    invalidAge: "🤔 Uxolo, leyo impendulo ayaziwa. Sicela uphendule ngeminyaka yakho (isb. 16 noma 34).",
    askAgeQuestion: "Uneminyaka emingaki? (isb. 16 noma 34)",
    askProvince: "Ngiyabonga! 📍\n\nUhlala kusiphi isifundazwe?",
    askProvinceRetry: "🤔 Uxolo, angisiqondanga leso sifundazwe. Uhlala kusiphi isifundazwe? 📍",
    provinceListButton: "Khetha isifundazwe",
    askStatus: "Siyabonga! ���� �� �� 📝\n\nOngasivotsha kodwa ungabasemuva kwamatsu 12, ungashada, ungasebenzisi noma usebenzela?",
    askStatusRetry: "���������🤔 Lokho akugcini impendulo. Sicela uphendule ngenombolo yolcuncu list ���� �� �� 👇",
    statusListButton: "Khetha umbulelo",
    askFunding: "Siyabonga! ���� �� �� 💰\n\nNgubani okususebenzayo ukufunda okokushada noma kokusebenze?",
    askFundingRetry: "���������🤔 Lokho akugcini impendulo. Sicela uphendule ngenombolo yolcuncu list ���� �� �� 👇",
    fundingListButton: "Khetha inkuthazo",
    assessmentIntro: (name) =>
    ...
    careerAiImpact: "🤖 *Umthelela we-AI kulo msebenzi:*",
    sponsoredNear: "\n\n🏫 *Inketho exhaswayo eduze kwakho:*",
    sponsorInfoPrompt: "\n\n💬 Phendula ngo-*INFO* ukuze uthole izidingo zokungena — awudingi iwebhusayithi edla idatha.",
    infoHeader: (college, course) => `🎓 *${course}*\ne-${college}\n\nNakhu okudingayo ukuze ungene:`,
    infoSubjects: "📘 *Izidingo zokungena:*",
    infoDuration: (yrs) => `⏳ *Ubude besifundo:* ${yrs} unyaka${yrs === 1 ? "" : " (iminyaka)"}`,
    infoApply: "🔗 *Faka isicelo noma ubabuze ngqo:*",
    infoNothingToShow: "🤔 Ayikho isifundo esixhaswayo engingakukhombisa imininingwane yaso okwamanje. Khetha umsebenzi ngezansi 👇\n\n",
    prospectusCaption: (collegeName) => `📄 *Incwadi egcwele ye-${collegeName}* — konke okumayelana nalesi sifundo, kuvela kubo ngokwabo.`,
    ...
    reportCaption: (name) =>
      ...
      "💌 *Ufuna umzali noma uthisha akubone lokhu?* Cindezela uphinde ubambe i-PDF engenhla, cindezela u-*Forward*, bese ukhetha ozomthumelela.\n\n" +
      "_Phendula ngo-REPORT noma nini ukuze uwuthole futhi._",
    yesnoButtons: ["Cha", "Mhlawumbe", "Yebo"],
    consentButtons: ["Ngiyavuma", "Okuningi"],
    // ---- Study paths (3-way menu) ----
    pathChoicePrompt: (name) =>
      `✅ Siyabonga ${name}, iphrofayela yakho isilungisiwe!\n\n` +
      `Ungathanda ukuthi i-Vula ikusize kanjani namuhla? 👇`,
    pathButtons: ["Yenza uvivinyo"],
    studyCategoryPrompt: "Kuhle! Iluphi uhlobo lomsebenzi olukuthakazelisa kakhulu? Khetha indawo ngizokukhombisa imisebenzi ekuyo. 👇",
    studyCategoryButton: "Khetha indawo",
    studyCareerListHeader: (area) => `💼 Imisebenzi ye-*${area}*:\n\n`,
    studyPickInstruction: (n) => `\n👉 Phendula ngenombolo (1–${n}) ukuze ubone ukuthi kudingekani ukuyifunda.`,
    studyNav: "\n\n_Phendula *AREAS* ukukhetha enye indawo, noma *QUIZ* ukwenza uvivinyo._",
    studyPickInvalid: "🤔 Uxolo, lokho akukho ohlwini. Sicela uphendule ngenombolo esohlwini 👇",
    subjectsMathsPrompt: "Ake sibone ukuthi izifundo zakho zivula ini! 📚\n\nOkokuqala — yiziphi *iZibalo* ozenzayo esikoleni? 👇",
    mathsButtons: ["Pure Maths", "Maths Literacy", "Awekho amaZibalo"],
    reachableHeader: (n) => `✅ Izindaba ezinhle — lokho kuvula imisebenzi engu-*${n}* ongayifundela:\n\n`,
    reachableNone: "Ngalezo zifundo azikho izimvumelwano eziqondile ohlwini lwami okwamanje — kodwa uvivinyo lwemibuzo engu-30 lungakukhombisa imisebenzi efanele izintshisekelo zakho. Phendula *QUIZ* ukuze uzame. 💡",
    reqSubjectsHeader: "*Izifundo ozozidinga:*",
    reqOpenEntry: "*Ukungena okuvulekile* — azikho izifundo ezithile ezidingekayo ukuqala.",
    reqMathsHeader: "*IZibalo:*",
    mathsPureRequired: "Kudingeka i-Pure Maths (i-Maths Literacy ayamukelwa).",
    mathsEitherOk: "I-Pure Maths noma i-Maths Literacy iyamukeleka.",
    mathsNoneNeeded: "Awadingeki amaZibalo ukungena.",
    reqVerifyCaveat: "⚠️ _Sicela uqinisekise lezi zidingo esikhungweni — zingahluka phakathi kwamakolishi futhi zishintshe unyaka nonyaka._",
    studyNoData: "🤔 Uxolo, anginayo imininingwane yokufunda yaleyo okwamanje.",
  },
  ...
  xh: {
    ...
    invalidAge: "🤔 Uxolo, loo mpendulo ayaziwa. Nceda uphendule ngeminyaka yakho (umz. 16 okanye 34).",
    askAgeQuestion: "Uneminyaka emingaphi? (umz. 16 okanye 34)",
    askProvince: "Enkosi! 📍\n\nUhlala kweliphi iphondo?",
    askProvinceRetry: "🤔 Uxolo, andiliqondanga elo phondo. Uhlala kweliphi iphondo? 📍",
    provinceListButton: "Khetha iphondo",
    askStatus: "Enkosi! ������ ���� ���� �� ���� �� �� 📝\n\nUngasivotsha kodwa uphumla eGrade 12, usebenzisi, uphumla esikolweni noma usebenzela?",
    askStatusRetry: "���������������������🤔 Lokho akugcini impendulo. Nceda uphendule ngenombolo yolcuncu list ������ ���� ���� �� ���� �� �� 👇",
    statusListButton: "Khetha umbhozo",
    askFunding: "Enkosi! ������ ���� ���� �� ���� �� �� 💰\n\nUngathini ukuthi uyokusebenzela nokufunda okokushada noma kokusebenze?",
    askFundingRetry: "���������������������🤔 Lokho akugcini impendulo. Nceda uphendule ngenombolo yolcuncu list ������ ���� ���� �� ���� �� �� 👇",
    fundingListButton: "Khetha inkuthazo",
    assessmentIntro: (name) =>
    ...
    careerAiImpact: "🤖 *Impembelelo ye-AI kulo msebenzi:*",
    sponsoredNear: "\n\n🏫 *Ukhetho oluxhaswayo olukufuphi:*",
    sponsorInfoPrompt: "\n\n💬 Phendula nge-*INFO* ukuze ufumane iimfuno zokungena — akukho webhusayithi etya idatha.",
    infoHeader: (college, course) => `🎓 *${course}*\ne-${college}\n\nNantsi into oyifunayo ukuze ungene:`,
    infoSubjects: "📘 *Iimfuno zokungena:*",
    infoDuration: (yrs) => `⏳ *Ubude bofundo:* ${yrs} unyaka${yrs === 1 ? "" : " (iminyaka)"}`,
    infoApply: "🔗 *Faka isicelo okanye ubabuze ngqo:*",
    infoNothingToShow: "🤔 Akukho sifundo sixhaswayo endinokukubonisa iinkcukacha zaso okwangoku. Khetha umsebenzi apha ngezantsi 👇\n\n",
    prospectusCaption: (collegeName) => `📄 *Incwadana epheleleyo ye-${collegeName}* — yonke into ngesi sifundo, ivela kubo ngokwabo.`,
    ...
    reportCaption: (name) =>
      ...
      "💌 *Ufuna umzali okanye utitshala ayibone le nto?* Cofa uxhase i-PDF engentla, cofa u-*Forward*, uze ukhethe umntu omthumelela.\n\n" +
      "_Phendula nge-REPORT nanini na ukuze uyifumane kwakhona._",
    yesnoButtons: ["Hayi", "Mhlawumbi", "Ewe"],
    consentButtons: ["Ndiyavuma", "Ulwazi oluninzi"],
    // ---- Study paths (3-way menu) ----
    pathChoicePrompt: (name) =>
      `✅ Enkosi ${name}, iprofayile yakho issetyenzisiwe!\n\n` +
      `Ungathanda ukuba i-Vula ikuncede njani namhlanje? 👇`,
    pathButtons: ["Yenza uvavanyo"],
    studyCategoryPrompt: "Kuhle! Loluphi uhlobo lomsebenzi olunomdla kuwe kakhulu? Khetha indawo ndikubonise imisebenzi ekuyo. 👇",
    studyCategoryButton: "Khetha indawo",
    studyCareerListHeader: (area) => `💼 Imisebenzi ye-*${area}*:\n\n`,
    studyPickInstruction: (n) => `\n👉 Phendula ngenombolo (1–${n}) ukubona into eyimfuneko ukuze uyifunde.`,
    studyNav: "\n\n_Phendula *AREAS* ukukhetha enye indawo, okanye *QUIZ* ukwenza uvavanyo._",
    studyPickInvalid: "🤔 Uxolo, oko akukho kuluhlu. Nceda phendula ngenombolo esuka kuluhlu 👇",
    subjectsMathsPrompt: "Makhe sibone izifundo zakho zivula ntoni! 📚\n\nOkokuqala — yeyiphi *iMathematika* oyenzayo esikolweni? 👇",
    mathsButtons: ["Pure Maths", "Maths Literacy", "Akukho Mathematika"],
    reachableHeader: (n) => `✅ Iindaba ezimnandi — oko kuvula imisebenzi engu-*${n}* onokuyifundela:\n\n`,
    reachableNone: "Ngezo zifundo akukho zidibaniso zithe ngqo kuluhlu lwam okwangoku — kodwa uvavanyo lwemibuzo engama-30 lunokukubonisa imisebenzi ehambelana nomdla wakho. Phendula *QUIZ* ukuzama. 💡",
    reqSubjectsHeader: "*Izifundo oza kuzidinga:*",
    reqOpenEntry: "*Ukungena okuvulekileyo* — akukho zifundo zithile zifunekayo ukuqala.",
    reqMathsHeader: "*IMathematika:*",
    mathsPureRequired: "Kufuneka i-Pure Maths (i-Maths Literacy ayamkelwa).",
    mathsEitherOk: "I-Pure Maths okanye i-Maths Literacy iyamkeleka.",
    mathsNoneNeeded: "Akukho Mathematika ifunekayo ukungena.",
    reqVerifyCaveat: "⚠️ _Nceda uqinisekise ezi mfuno kwiziko — zinokwahluka phakathi kweekholeji kwaye zitshintshe unyaka ngonyaka._",
    studyNoData: "🤔 Uxolo, andinayo iinkcukacha zokufunda zaleyo okwangoku.",
  },
  ...
  af: {
    ...
    invalidAge: "🤔 Jammer, dit is nie 'n herkenbare antwoord nie. Antwoord asseblief met jou ouderdom (bv. 16 of 34).",
    askAgeQuestion: "Hoe oud is jy? (bv. 16 of 34)",
    askProvince: "Dankie! 📍\n\nIn watter provinsie woon jy?",
    askProvinceRetry: "🤔 Jammer, ek herken nie daardie provinsie nie. In watter provinsie woon jy? 📍",
    provinceListButton: "Kies provinsie",
    askStatus: "Dankie! ���� ���� ���� ���� ���� ���� �� �� �� �� �� �� �� 📝\n\nIs jy tans in Graad 12, werksloos, aan die studeer of aan die werk?",
    askStatusRetry: "�����������������������������🤔 Jammer, dit is nie 'n herkenbare antwoord nie. Antwoord asseblief met 'n nommer van die lys ������ ���� ���� �� ���� �� �� 👇",
    statusListButton: "Kies status",
    askFunding: "Dankie! ���� ���� ���� ���� ���� ���� �� �� �� �� �� �� �� 💰\n\nHoe plan jy om jou tertiêre studies of volgende carrièrebeweging te finansier?",
    askFundingRetry: "�����������������������������🤔 Jammer, dit is nie 'n herkenbare antwoord nie. Antwoord asseblief met 'n nommer van die lys ������ ���� ���� �� ���� �� �� 👇",
    fundingListButton: "Kies finansiering",
    assessmentIntro: (name) =>
    ...
    exploreInstruction: (n) => `\n👉 Antwoord met 'n *nommer (1–${n})* om 'n loopbaan te verken — hoekom dit by jou pas, wat jy nodig het om daar te kom, en hoe om te kwalifiseer.`,
    ...
    careerAiImpact: "🤖 *AI se impak op hierdie loopbaan:*",
    sponsoredNear: "\n\n🏫 *Geborgde opsie naby jou:*",
    sponsorInfoPrompt: "\n\n💬 Antwoord *INFO* vir toelatingsvereistes — geen data-swaar webwerf nodig nie.",
    infoHeader: (college, course) => `🎓 *${course}*\nby ${college}\n\nDit is wat jy nodig het om in te kom:`,
    infoSubjects: "📘 *Toelatingsvereistes:*",
    infoDuration: (yrs) => `⏳ *Studieduur:* ${yrs} jaar`,
    infoApply: "🔗 *Doen aansoek of vra hulle direk:*",
    infoNothingToShow: "🤔 Daar is nog geen geborgde kursus om besonderhede voor te wys nie. Kies 'n loopbaan hieronder 👇\n\n",
    prospectusCaption: (collegeName) => `📄 *${collegeName} se volledige prospektus* — alles oor hierdie kursus, direk van hulle af.`,
    ...
    reportCaption: (name) =>
      ...
      "Dit stel jou sterkpunte, jou passende loopbane, presies wat jy nodig het om daar te kom en hoe om te kwalifiseer uiteen.\n\n" +
      "💌 *Wil jy dit met iemand deel?* Druk en hou die PDF hierbo, tik *Forward*, en kies vir wie om dit te stuur.\n\n" +
      "_Antwoord REPORT enige tyd om dit weer te kry._",
    yesnoButtons: ["Nee", "Miskien", "Ja"],
    consentButtons: ["Ek stem saam", "Meer inligting"],
    // ---- Study paths (3-way menu) ----
    pathChoicePrompt: (name) =>
      `✅ Dankie ${name}, jou profiel is gestel!\n\n` +
      `Hoe wil jy hê moet Vula jou vandag help? 👇`,
    pathButtons: ["Doen die vasvra"],
    studyCategoryPrompt: "Great! Watter soort werk interesseer jou die meeste? Kies 'n area en ek wys jou loopbane daarin. 👇",
    studyCategoryButton: "Kies 'n area",
    studyCareerListHeader: (area) => `💼 *${area}* loopbane:\n\n`,
    studyPickInstruction: (n) => `\n👉 Antwoord met 'n *nommer (1–${n})* om te sien presies wat dit verg om dit te studeer.`,
    studyNav: "\n\n_Antwoord *AREAS* om 'n ander area te kies, of *QUIZ* om die assessering te doen._",
    studyPickInvalid: "🤔 Jammer, dit is nie op die lys nie. Antwoord asseblief met 'n nommer uit die lys 👇",
    subjectsMathsPrompt: "Kom ons kyk wat jou vakke oopmaak! 📚\n\nEerstens — watter *Wiskunde* neem jy op skool? 👇",
    mathsButtons: ["Suiwer Wiskunde", "Wiskunde Geletterdh.", "Geen Wiskunde"],
    reachableHeader: (n) => `✅ Goeie nuus — dit maak *${n}* loopbane oop waarvoor jy kan studeer:\n\n`,
    reachableNone: "Met daardie vakke is daar nog geen direkte passings in my lys nie — maar die 30-vraag vasvra kan jou steeds na loopbane wys wat by jou belangstellings pas. Antwoord *QUIZ* om dit te probeer. 💡",
    reqSubjectsHeader: "*Vakke wat jy sal nodig hê:*",
    reqOpenEntry: "*Oop toegang* — geen spesifieke skoolvakke word vereis om te begin nie.",
    reqMathsHeader: "*Wiskunde:*",
    mathsPureRequired: "Suiwer Wiskunde word vereis (Wiskunde Geletterdheid word nie aanvaar nie).",
    mathsEitherOk: "Suiwer Wiskunde of Wiskunde Geletterdheid word aanvaar.",
    mathsNoneNeeded: "Geen Wiskunde-vereiste om in te kom nie.",
    reqVerifyCaveat: "⚠️ _Bevestig asseblief hierdie presiese vereistes met die instelling — dit kan tussen kolleges verskil en jaar tot jaar verander._",
    studyNoData: "🤔 Jammer, ek het nog nie die studiebesonderhede vir daardie een nie.",
  },
};
