...
const STRINGS = {
  en: {
    ...
    welcome:
      ...
      "• We'll ask a few details (name, surname, school, age, grade, province) to give you accurate guidance.\n" +
    ...
    moreInfo:
      ...
      "• We only collect what's needed to guide you: name, surname, school, age, grade, province and your answers.\n" +
  ...
  zu: {
    ...
    welcome:
      ...
      "• Sizobuza imininingwane embalwa (igama, isibongo, isikole, iminyaka, ibanga, isifundazwe) ukuze sikunikeze isiqondiso esiqondile.\n" +
    ...
    moreInfo:
      ...
      "• Siqoqa kuphela lokho okudingekayo ukuze sikuqondise: igama, isibongo, isikole, iminyaka, ibanga, isifundazwe nezimpendulo zakho.\n" +
  ...
  xh: {
    ...
    welcome:
      ...
      "• Siza kubuza iinkcukacha ezimbalwa (igama, ifani, isikolo, iminyaka, ibanga, iphondo) ukukunika isikhokelo esichanekileyo.\n" +
    ...
    moreInfo:
      "🔒 *Indlela i-Vula esebenzisa ngayo ulwazi lwakho*\n\n" +
      "• Siqokelela kuphela oko kufunekayo ukuze sikukhokele: igama, ifani, isikolo, iminyaka, ibanga, iphondo kunye neempendulo zakho.\n" +
  ...
  af: {
    ...
    welcome:
      ...
      "• Ons sal 'n paar besonderhede vra (naam, van, skool, ouderdom, graad, provinsie) om jou akkurate leiding te gee.\n" +
    ...
    moreInfo:
      ...
      "• Ons versamel net wat nodig is om jou te lei: naam, van, skool, ouderdom, graad, provinsie en jou antwoorde.\n" +
