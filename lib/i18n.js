...
const STRINGS = {
  en: {
    ...
    pathButtons: ["Do the quiz", "I know my study", "Study by subject"],
  ...
  zu: {
    ...
    pathButtons: ["Yenza uvivinyo", "Ngiyazi ukufunda", "Funda ngezifundo"],
  ...
  xh: {
    ...
    pathButtons: ["Yenza uvavanyo", "Ndiyakwazi endikuf.", "Funda ngezifundo"],
  ...
  af: {
    ...
    pathButtons: ["Doen die vasvra", "Ek weet my studie", "Studeer per vak"],
