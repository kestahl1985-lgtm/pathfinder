...
const CAREERS = [
  { id: "engineer", name: "Engineer (Civil/Mechanical/Electrical)", traits: ["R", "I"], list: "Design and build the physical world",
    ...
    aiImpact: "Medium", aiImpactNote: "Design work is increasingly AI-assisted, but green-energy engineering is one of the fastest-growing fields globally, and safety sign-off stays with a licensed engineer." },
  { id: "electrician", name: "Electrician", traits: ["R"], list: "Install and repair electrical systems",
    ...
    aiImpact: "Low", aiImpactNote: "A hands-on physical trade — one of the job categories AI barely touches." },
  { id: "mechanic", name: "Motor Mechanic", traits: ["R"], list: "Diagnose and repair vehicles",
    ...
    aiImpact: "Low", aiImpactNote: "Hands-on diagnostic and repair work — diagnostic software helps, but doesn't replace it." },
  { id: "doctor", name: "Doctor (Medicine)", traits: ["I", "S"], list: "Diagnose and treat patients",
    ...
    aiImpact: "Low", aiImpactNote: "Even where AI helps most (like reading scans), it assists rather than replaces — clinical judgement and patient care stay with the doctor." },
  { id: "datasci", name: "Data Scientist / IT Specialist", traits: ["I", "C"], list: "Find answers in data & build tech",
    ...
    aiImpact: "Medium", aiImpactNote: "One of the most AI-tool-heavy careers day to day, yet also one of the fastest-growing — because these are the people who build and direct AI systems." },
  { id: "scientist", name: "Scientist / Researcher", traits: ["I"], list: "Investigate how the world works",
    ...
    aiImpact: "Medium", aiImpactNote: "AI speeds up literature review and data analysis, but designing experiments and forming conclusions stays human-led." },
  { id: "designer", name: "Graphic / UX Designer", traits: ["A"], list: "Create visuals, brands and apps",
    ...
    aiImpact: "Medium", aiImpactNote: "AI tools now handle a lot of routine layout and asset work, but design strategy and client judgement remain a human skill worth building." },
  { id: "architect", name: "Architect", traits: ["A", "R"], list: "Design buildings and spaces",
    ...
    aiImpact: "Low", aiImpactNote: "AI is changing daily drafting work, but the legal sign-off on structural and safety decisions stays with a registered architect." },
  { id: "media", name: "Journalist / Media & Content", traits: ["A", "S"], list: "Tell stories across media",
    ...
    aiImpact: "Medium", aiImpactNote: "AI helps with research and first drafts, but original reporting and editorial judgement stay human." },
  { id: "teacher", name: "Teacher", traits: ["S"], list: "Educate and shape young minds",
    ...
    aiImpact: "Low", aiImpactNote: "In-person teaching and relationship-building with learners is strongly protected — expect to use AI tools, not be replaced by them." },
  { id: "nurse", name: "Nurse", traits: ["S", "I"], list: "Care for patients' health",
    ...
    aiImpact: "Low", aiImpactNote: "Hands-on clinical care built on human connection — empathy and person-centred care are widely seen as irreplaceable." },
  { id: "socialworker", name: "Social Worker", traits: ["S"], list: "Support people and communities",
    ...
    aiImpact: "Low", aiImpactNote: "Deeply relational, in-person work — among the careers researchers rate as least exposed to AI." },
  { id: "entrepreneur", name: "Entrepreneur / Business Owner", traits: ["E"], list: "Build and run your own business",
    ...
    aiImpact: "Low", aiImpactNote: "There's no fixed task-set to automate — entrepreneurship is about adapting to new tools, including AI, not being replaced by them." },
  { id: "lawyer", name: "Lawyer", traits: ["E", "I"], list: "Advise, argue and uphold justice",
    ...
    aiImpact: "Medium", aiImpactNote: "Routine research and document drafting are increasingly AI-assisted, but court representation and client accountability stay with a licensed lawyer." },
  { id: "marketing", name: "Marketing & Sales", traits: ["E", "A"], list: "Promote products and win customers",
    ...
    aiImpact: "Medium", aiImpactNote: "AI now drafts a lot of ad copy and content, but strategy, relationships and negotiation stay human-led." },
  { id: "accountant", name: "Accountant / Chartered Accountant", traits: ["C", "I"], list: "Manage money, audits and finances",
    ...
    aiImpact: "Medium", aiImpactNote: "AI automates routine data entry, but judgement-heavy work like audit review and advisory is actually projected to grow." },
  ...
  { id: "logistics", name: "Logistics & Supply Chain", traits: ["C", "E"], list: "Move goods and plan operations",
    ...
    aiImpact: "Medium", aiImpactNote: "Route planning and forecasting are increasingly AI/algorithm-driven, but coordinating people and handling exceptions when things go wrong stays human." },
];
